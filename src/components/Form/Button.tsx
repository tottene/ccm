...
const button = tv({
    base: [
        'rounded-lg px-4 py-2 text-sm outline-none shadow-sm',
    ...
    variants: {
        variant: {
            ...
            ghost: 
              'rounder-md px-2 hover:bg-zinc-50 dark:hover:bg-white/5 shadow-none text-zinc-500 dark:text-zinc-400',
